...
public class VideoStoreTest {
    ...
    public void testSingleNewReleaseStatementTotals() {
        ...
        assertEquals(2, statement.getFrequenRenterPoints());
    }
    ...
    public void testDualNewReleaseStatementTotals() {
        ...
        assertEquals(4, statement.getFrequenRenterPoints());
    }
    ...
    public void testSingleChildrensStatementTotals() {
        ...
        assertEquals(1, statement.getFrequenRenterPoints());
    }
    ...
    public void testMultipleRegularStatementTotals() {
        ...
        assertEquals(3, statement.getFrequenRenterPoints());
    }
